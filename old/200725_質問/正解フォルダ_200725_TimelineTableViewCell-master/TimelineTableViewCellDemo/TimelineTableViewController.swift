...
class TimelineTableViewController: UITableViewController {
    ...
    let data:[Int: [(TimelinePoint, UIColor, String, String, String?, [String]?, String?,String?)]] =
        [0:[
            (TimelinePoint(), UIColor.black, "2020/07/05", "オクトモア", nil, nil, "01","10"),
            (TimelinePoint(), UIColor.black, "2020/06/05", "アードベック", nil, nil, "01","11"),
            (TimelinePoint(), UIColor.clear, "2020/05/05", "グレンドロナック", nil, nil, "01","12"),
            (TimelinePoint(), UIColor.clear, "2020/04/05", "", nil, nil, "",""),
            (TimelinePoint(), UIColor.black, "2020/03/05", "オーヘットシャン", nil, nil, "01","13"),
            (TimelinePoint(), UIColor.black, "2020/02/05", "", nil, nil, "01",""),
            (TimelinePoint(), UIColor.clear, "2020/01/05", "マッカラン", nil, nil, "01","14"),],
                                                                                               
        1:[(TimelinePoint(), UIColor.clear, "2019/12/05", "", nil, nil, "",""),
           (TimelinePoint(), UIColor.clear, "2019/12/05", "グレンフィディック", nil, nil, "01","15"),
            ]]
