...
class TimelineTableViewController: UITableViewController {
    ...
    // TimelinePoint, Timeline back color, title, description, lineInfo, thumbnails, illustration, whisky_icon,Level
    let data:[Int: [(TimelinePoint, UIColor, String, String, String?, [String]?, String?,String?)]] =
        [0:[
            (TimelinePoint(), UIColor.black, "2020/07/05", "オクトモア", nil, nil, "check","10"),
            (TimelinePoint(), UIColor.black, "2020/06/05", "アードベック", nil, nil, "check","11"),
            (TimelinePoint(), UIColor.clear, "2020/05/05", "グレンドロナック", nil, nil, "check","12"),
            (TimelinePoint(), UIColor.clear, "2020/04/05", "", nil, nil, "",""),
            (TimelinePoint(), UIColor.black, "2020/03/05", " Level1クリア！", nil, nil, "check","target.png"),
            (TimelinePoint(), UIColor.black, "2020/02/05", "", nil, nil, "",""),
            (TimelinePoint(), UIColor.clear, "2020/01/05", "マッカラン", nil, nil, "check","14"),],
                                                                                               
        1:[(TimelinePoint(), UIColor.clear, "2019/12/05", "", nil, nil, "",""),
           (TimelinePoint(), UIColor.clear, "2019/12/05", "グレンフィディック", nil, nil, "check","15"),
            ]]
